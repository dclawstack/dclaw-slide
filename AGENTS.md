...
**DClaw Slide** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8021` (FastAPI)
- **Frontend Port:** `3021` (Next.js)
- **Database:** `dclaw_slide` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3021`
